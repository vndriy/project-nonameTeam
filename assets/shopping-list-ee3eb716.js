import"./support-ua-43a6c177.js";const n=document.querySelector(".body"),l=document.querySelector(".empty-basket-wrap");console.log(l);window.addEventListener("load",g);function g(){const o=localStorage.getItem("shopping-list"),s=JSON.parse(o);if(s.length===0){n.classList.add("block-hidden");return}else l.style.display="none",d(s)}function m(o){for(const s of o)return s.url}function d(o){o.map(({_id:t,buy_links:a,author:r,title:e,description:c,book_image:i,list_name:p})=>{const u=a[1];n.insertAdjacentHTML("beforeend",`
